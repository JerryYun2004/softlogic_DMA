...
`endif
    ...
    //Tile_X0Y2_Direction.EAST
        input  [3:0] Tile_X0Y2_E1END, //TilePort({W} INPUT E1END[3:0])
        input  [7:0] Tile_X0Y2_E2MID, //TilePort({W} INPUT E2MID[7:0])
        input  [7:0] Tile_X0Y2_E2END, //TilePort({W} INPUT E2END[7:0])
        input  [15:0] Tile_X0Y2_EE4END, //TilePort({W} INPUT EE4END[3:0])
        input  [11:0] Tile_X0Y2_E6END, //TilePort({W} INPUT E6END[1:0])
        output  [3:0] Tile_X0Y2_W1BEG, //TilePort({W} OUTPUT W1BEG[3:0])
        output  [7:0] Tile_X0Y2_W2BEG, //TilePort({W} OUTPUT W2BEG[7:0])
        output  [7:0] Tile_X0Y2_W2BEGb, //TilePort({W} OUTPUT W2BEGb[7:0])
        output  [15:0] Tile_X0Y2_WW4BEG, //TilePort({W} OUTPUT WW4BEG[3:0])
        output  [11:0] Tile_X0Y2_W6BEG, //TilePort({W} OUTPUT W6BEG[1:0])
    //Tile_X0Y3_Direction.EAST
        input  [3:0] Tile_X0Y3_E1END, //TilePort({W} INPUT E1END[3:0])
        input  [7:0] Tile_X0Y3_E2MID, //TilePort({W} INPUT E2MID[7:0])
        input  [7:0] Tile_X0Y3_E2END, //TilePort({W} INPUT E2END[7:0])
        input  [15:0] Tile_X0Y3_EE4END, //TilePort({W} INPUT EE4END[3:0])
        input  [11:0] Tile_X0Y3_E6END, //TilePort({W} INPUT E6END[1:0])
        output  [3:0] Tile_X0Y3_W1BEG, //TilePort({W} OUTPUT W1BEG[3:0])
        output  [7:0] Tile_X0Y3_W2BEG, //TilePort({W} OUTPUT W2BEG[7:0])
        output  [7:0] Tile_X0Y3_W2BEGb, //TilePort({W} OUTPUT W2BEGb[7:0])
        output  [15:0] Tile_X0Y3_WW4BEG, //TilePort({W} OUTPUT WW4BEG[3:0])
        output  [11:0] Tile_X0Y3_W6BEG, //TilePort({W} OUTPUT W6BEG[1:0])
    //Tile_X0Y4_Direction.EAST
        input  [3:0] Tile_X0Y4_E1END, //TilePort({W} INPUT E1END[3:0])
        input  [7:0] Tile_X0Y4_E2MID, //TilePort({W} INPUT E2MID[7:0])
        input  [7:0] Tile_X0Y4_E2END, //TilePort({W} INPUT E2END[7:0])
        input  [15:0] Tile_X0Y4_EE4END, //TilePort({W} INPUT EE4END[3:0])
        input  [11:0] Tile_X0Y4_E6END, //TilePort({W} INPUT E6END[1:0])
        output  [3:0] Tile_X0Y4_W1BEG, //TilePort({W} OUTPUT W1BEG[3:0])
        output  [7:0] Tile_X0Y4_W2BEG, //TilePort({W} OUTPUT W2BEG[7:0])
        output  [7:0] Tile_X0Y4_W2BEGb, //TilePort({W} OUTPUT W2BEGb[7:0])
        output  [15:0] Tile_X0Y4_WW4BEG, //TilePort({W} OUTPUT WW4BEG[3:0])
        output  [11:0] Tile_X0Y4_W6BEG, //TilePort({W} OUTPUT W6BEG[1:0])
    ...
    //Tile_X0Y5_Direction.EAST
        input  [3:0] Tile_X0Y5_E1END, //TilePort({W} INPUT E1END[3:0])
        input  [7:0] Tile_X0Y5_E2MID, //TilePort({W} INPUT E2MID[7:0])
        input  [7:0] Tile_X0Y5_E2END, //TilePort({W} INPUT E2END[7:0])
        input  [15:0] Tile_X0Y5_EE4END, //TilePort({W} INPUT EE4END[3:0])
        input  [11:0] Tile_X0Y5_E6END, //TilePort({W} INPUT E6END[1:0])
        output  [3:0] Tile_X0Y5_W1BEG, //TilePort({W} OUTPUT W1BEG[3:0])
        output  [7:0] Tile_X0Y5_W2BEG, //TilePort({W} OUTPUT W2BEG[7:0])
        output  [7:0] Tile_X0Y5_W2BEGb, //TilePort({W} OUTPUT W2BEGb[7:0])
        output  [15:0] Tile_X0Y5_WW4BEG, //TilePort({W} OUTPUT WW4BEG[3:0])
        output  [11:0] Tile_X0Y5_W6BEG, //TilePort({W} OUTPUT W6BEG[1:0])
