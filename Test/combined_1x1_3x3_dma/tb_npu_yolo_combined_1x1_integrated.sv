...
`define YOLO_IMAGE_MEM "yolo_conv1_in.mem"
`endif

`ifndef YOLO_WEIGHTS_MEM
`define YOLO_WEIGHTS_MEM "yolo_conv1_w.mem"
`endif
...
//   * combined_hwc_channel_dma_agu runs in CPU-selected 1x1 mode.
...
// datapath.
module tb_npu_yolo_combined_1x1_integrated;
    ...
    initial begin : optional_waveform
        if ($value$plusargs("VCD=%s", vcd_path)) begin
            $dumpfile(vcd_path);
            $dumpvars(0, tb_npu_yolo_combined_1x1_integrated);
        end
    end
